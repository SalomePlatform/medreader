...
def test(baseline_file):
    ...
    if '-D' not in sys.argv:
        ...
        a1_fGauss_PVLookupTable = GetColorTransferFunction( "fNode", RGBPoints=[0.22, 0.23, 0.299, 0.754, 2.95, 0.706, 0.016, 0.15], VectorMode='Magnitude', NanColor=[0.25, 0.0, 0.0], ColorSpace='Diverging', ScalarRangeInitialized=1.0, AllowDuplicateScalars=1 )
