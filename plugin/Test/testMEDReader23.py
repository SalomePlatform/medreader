...
MyAssert(myMedReader.PointData.GetNumberOfArrays() in [1, 2]) # + 1 vtkGhostType
MyAssert('GlobalNodeIds' in  [myMedReader.PointData.GetArray(i).GetName() for i in range(myMedReader.PointData.GetNumberOfArrays())] )
